...
namespace BEPUutilities
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<FPVector3> points)
        {
        ...
        public static void RemoveRedundantPoints(IList<FPVector3> points, FP cellSize)
        {
        ...
        /// </summary>
        /// <param name="points">List of points to prune.</param>
        public static void RemoveRedundantPoints(RawList<FPVector3> points)
        {
            RemoveRedundantPoints(points, F64.C0p001);
        }
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<FPVector3> points, FP cellSize)
        {
