...
namespace BEPUutilities
{
	public static class F64
	{
        ...
        public static readonly FP Half = FP.One / 2;
        public static readonly FP OneEighth = FP.One / 8;
		...
		public static readonly FP C1m1em12 = FP.One - (FP)1e-12m;
		public static readonly FP GoldenRatio = FP.One + FP.Sqrt((FP)5) / (FP)2;
		public static readonly FP OneTwelfth = FP.One / (FP)12;
