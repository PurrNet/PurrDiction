        ...
        public override void UpdateTimeOfImpact(Collidable requester, FP dt)
        {
            ...
            if (convex.IsActive && convex.entity.PositionUpdateMode == PositionUpdateMode.Continuous)
            {
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    FPVector3 terrainUp = new FPVector3(terrain.worldTransform.LinearTransform.M21, terrain.worldTransform.LinearTransform.M22, terrain.worldTransform.LinearTransform.M23);
                    ...
                    for (int i = 0; i < TerrainManifold.overlappedTriangles.Count; i++)
                    {
                            ...
                            rayHit.T > Toolbox.BigEpsilon)
                        {
                            ...
                            FP dot;
                            FPVector3.Dot(ref normal, ref terrainUp, out dot);
                            if (dot < F64.C0)
