...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class QuaternionSlerpCurve : Curve<FPQuaternion>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, FP weight, out FPQuaternion value)
        {
            value = FPQuaternion.Slerp(ControlPoints[controlPointIndex].Value, ControlPoints[controlPointIndex + 1].Value, weight);
        }
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<FPQuaternion> curveControlPoint, int index)
        {
        }
        ...
        protected internal override void ControlPointRemoved(CurveControlPoint<FPQuaternion> curveControlPoint, int oldIndex)
        {
        }
        ...
        protected internal override void ControlPointTimeChanged(CurveControlPoint<FPQuaternion> curveControlPoint, int oldIndex, int newIndex)
        {
        }
        ...
        /// </summary>
        /// <param name="curveControlPoint">Changed control point.</param>
        protected internal override void ControlPointValueChanged(CurveControlPoint<FPQuaternion> curveControlPoint)
        {
        }
    }
}