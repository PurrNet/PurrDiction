...
namespace BEPUphysics.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        public FPVector2 MovementDirection
        {
            ...
            set
            {
                if (movementDirection.x != value.x || movementDirection.y != value.y) //Fix64ing point comparison is perfectly fine here. Any bitwise variation should go through.
                {
                    ...
                    {
                        FPVector2.Divide(ref value, FP.Sqrt(lengthSquared), out movementDirection);
                    }
                    else
                    {
        ...
        /// </summary>
        public FP MaximumAccelerationForce { get; set; }
        FP maxForceDt;
        FP maxAccelerationForceDt;

        private FP timeUntilPositionAnchor = (FP).2m;
        ...
        /// </summary>
        public FP TimeUntilPositionAnchor
        {
        ...
        /// </summary>
        public FP PositionAnchorDistanceThreshold { get; set; }
        ...
        internal FPVector3 movementDirection3d;
        ...
        public void UpdateMovementBasis(ref FPVector3 forward)
        {
            ...
            {
                FPVector3.Divide(ref horizontalForwardDirection, FP.Sqrt(forwardLengthSquared), out horizontalForwardDirection);
        ...
        public HorizontalMotionConstraint(Entity characterBody, SupportFinder supportFinder)
        {
            ...
            MaximumAccelerationForce = FP.MaxValue;
        }
        ...
        public override void Update(FP dt)
        {
            ...
            if (MovementMode != MovementMode.Floating)
            {
                ...
                if (isTryingToMove)
                {
                    ...
                    FPPlane plane = new FPPlane(supportData.Normal, F64.C0);
                    FP t;
                ...
                else
                {
                    ...
                    FP length = linearJacobianA1.LengthSquared();
                    ...
                    FPVector3.Divide(ref linearJacobianA1, FP.Sqrt(length), out linearJacobianA1);
        ...
        public override FP SolveIteration()
        {
            ...
            else
            {
                ...
                {
                    FPVector2.Multiply(ref accumulatedImpulse, maxForceDt / FP.Sqrt(length), out accumulatedImpulse);
                }
