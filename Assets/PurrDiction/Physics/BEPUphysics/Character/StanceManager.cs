...
namespace BEPUphysics.Character
{
    ...
    public class StanceManager
    {
        ...
        public StanceManager(Cylinder characterBody, FP crouchingHeight, FP proneHeight, QueryManager queryManager, SupportFinder supportFinder)
        {
        ...
        private void PrepareQueryObject(EntityCollidable queryObject, ref FPVector3 position)
        {
            ...
            if (CurrentStance != targetStance)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        FP lowestBound = F64.C0;
                        FP originalHighestBound = (targetHeight - currentHeight) * -F64.C0p5;
                        FP highestBound = originalHighestBound;
                        FP currentOffset = F64.C0;
                        ...
                        {
                            FPVector3 candidatePosition = currentPosition + currentOffset * down;
                            FP hintOffset;
        ...
        public bool UpdateStance(out FPVector3 newPosition)
        {
            FP newHeight;
        ...
        CharacterContactPositionState TrySupportLocation(ConvexCollidable<CylinderShape> queryObject, ref FPVector3 position, out FP hintOffset,
