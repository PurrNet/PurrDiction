...
namespace BEPUphysics.CollisionShapes
{
    ...
    public abstract class EntityShape : CollisionShape
    {
        ...
        public abstract void GetBoundingBox(ref RigidTransform transform, out FPBoundingBox boundingBox);
        ...
        protected void TransformLocalExtremePoints(ref FPVector3 x, ref FPVector3 y, ref FPVector3 z, ref Matrix3x3 transform, out FPVector3 result)
        {
