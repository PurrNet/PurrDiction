...
namespace BEPUphysics.DataStructures
{
    ...
    public class MeshBoundingBoxTree
    {
        ...
        public bool GetOverlaps(FPBoundingBox boundingBox, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                bool intersects;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(FPBoundingSphere boundingSphere, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                bool intersects;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(FPRay ray, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                FP result;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(FPRay ray, FP maximumLength, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                FP result;
        ...
        abstract class Node
        {
            ...
            internal abstract void GetOverlaps(ref FPBoundingBox boundingBox, IList<int> outputOverlappedElements);
            internal abstract void GetOverlaps(ref FPBoundingSphere boundingSphere, IList<int> outputOverlappedElements);
            //internal abstract void GetOverlaps(ref BoundingFrustum boundingFrustum, IList<int> outputOverlappedElements);
            internal abstract void GetOverlaps(ref FPRay ray, FP maximumLength, IList<int> outputOverlappedElements);
        ...
        sealed class InternalNode : Node
        {
            ...
            internal override void GetOverlaps(ref FPBoundingBox boundingBox, IList<int> outputOverlappedElements)
            {
            ...
            internal override void GetOverlaps(ref FPBoundingSphere boundingSphere, IList<int> outputOverlappedElements)
            {
                bool intersects;
            ...
            internal override void GetOverlaps(ref FPRay ray, FP maximumLength, IList<int> outputOverlappedElements)
            {
                FP result;
