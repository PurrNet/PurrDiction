...
namespace BEPUphysics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(FPVector3[] vertices, int[] indices)
        {
            Vertices = vertices;
            Indices = indices;
        }
        ...
        public TransformableMeshData(FPVector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
        ...
        public override void GetTriangle(int triangleIndex, out FPVector3 v1, out FPVector3 v2, out FPVector3 v3)
        {
        ...
        public override void GetVertexPosition(int i, out FPVector3 vertex)
        {
