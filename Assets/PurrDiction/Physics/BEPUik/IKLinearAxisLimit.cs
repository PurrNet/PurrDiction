...
namespace BEPUik
{
    ...
    public class IKLinearAxisLimit : IKLimit
    {
        ...
        public IKLinearAxisLimit(Bone connectionA, Bone connectionB, FPVector3 lineAnchor, FPVector3 lineDirection, FPVector3 anchorB, FP minimumDistance, FP maximumDistance)
