...
namespace Jitter2.LinearMath
{
    ...
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 3*Real.SIZE_OF)]
    public partial struct JVector : IEquatable<JVector>
    {
        internal static JVector InternalZero;
        internal static JVector Arbitrary;

        [FieldOffset(0*Real.SIZE_OF)] public Real X;
        [FieldOffset(1*Real.SIZE_OF)] public Real Y;
        [FieldOffset(2*Real.SIZE_OF)] public Real Z;
        ...
        {
            var ptr = (Real*)Unsafe.AsPointer(ref this);
        ...
        {
            Transform(vector, matrix, out var result);
            return result;
        }
        ...
        {
            Transform(vector, quat, out var result);
            return result;
        }
        ...
        {
            TransposedTransform(vector, matrix, out var result);
            return result;
        }
        ...
        {
            ConjugatedTransform(vector, quat, out var result);
            return result;
        }
        ...
        {
            var num0 = vector.X * matrix.M11 + vector.Y * matrix.M12 + vector.Z * matrix.M13;
            var num1 = vector.X * matrix.M21 + vector.Y * matrix.M22 + vector.Z * matrix.M23;
            var num2 = vector.X * matrix.M31 + vector.Y * matrix.M32 + vector.Z * matrix.M33;
        ...
        {
            var num0 = vector.X * matrix.M11 + vector.Y * matrix.M21 + vector.Z * matrix.M31;
            var num1 = vector.X * matrix.M12 + vector.Y * matrix.M22 + vector.Z * matrix.M32;
            var num2 = vector.X * matrix.M13 + vector.Y * matrix.M23 + vector.Z * matrix.M33;
        ...
        {
            var num0 = 2.0 * (quaternion.Y * vector.Z - quaternion.Z * vector.Y);
            var num1 = 2.0 * (quaternion.Z * vector.X - quaternion.X * vector.Z);
            var num2 = 2.0 * (quaternion.X * vector.Y - quaternion.Y * vector.X);

            var num00 = quaternion.Y * num2 - quaternion.Z * num1;
            var num11 = quaternion.Z * num0 - quaternion.X * num2;
            var num22 = quaternion.X * num1 - quaternion.Y * num0;
        ...
        {
            var num0 = 2.0 * (quaternion.Z * vector.Y - quaternion.Y * vector.Z);
            var num1 = 2.0 * (quaternion.X * vector.Z - quaternion.Z * vector.X);
            var num2 = 2.0 * (quaternion.Y * vector.X - quaternion.X * vector.Y);

            var num00 = quaternion.Z * num1 - quaternion.Y * num2;
            var num11 = quaternion.X * num2 - quaternion.Z * num0;
            var num22 = quaternion.Y * num0 - quaternion.X * num1;
        ...
        {
            var num0 = vector1.Y * vector2.Z - vector1.Z * vector2.Y;
            var num1 = vector1.Z * vector2.X - vector1.X * vector2.Z;
            var num2 = vector1.X * vector2.Y - vector1.Y * vector2.X;
        ...
        public static JVector NormalizeSafe(in JVector value, Real epsilonSquared /*= (Real)1e-16*/)
        {
            ...
            return (1.0 / MathR.Sqrt(len2)) * value;
        }

        public static void NormalizeInPlace(ref JVector toNormalize)
        {
            var num2 = toNormalize.LengthSquared();
            var num = 1.0 / MathR.Sqrt(num2);
            toNormalize.X *= num;
            toNormalize.Y *= num;
            toNormalize.Z *= num;
        }
        ...
        public readonly Real GetElement(int i)
        {
            return i switch
            {
                0 => X,
