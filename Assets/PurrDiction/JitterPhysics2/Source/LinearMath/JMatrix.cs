...
namespace Jitter2.LinearMath
{
    ...
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 9*Real.SIZE_OF)]
    public struct JMatrix : IEquatable<JMatrix>
    {
        [FieldOffset(0*Real.SIZE_OF)] public Real M11;
        [FieldOffset(1*Real.SIZE_OF)] public Real M21;
        [FieldOffset(2*Real.SIZE_OF)] public Real M31;
        [FieldOffset(3*Real.SIZE_OF)] public Real M12;
        [FieldOffset(4*Real.SIZE_OF)] public Real M22;
        [FieldOffset(5*Real.SIZE_OF)] public Real M32;
        [FieldOffset(6*Real.SIZE_OF)] public Real M13;
        [FieldOffset(7*Real.SIZE_OF)] public Real M23;
        [FieldOffset(8*Real.SIZE_OF)] public Real M33;
        ...
        {
            Real c = MathR.Cos(angle / 2.0);
            Real s = MathR.Sin(angle / 2.0);
            axis *= s;
        ...
        {
            Real idet = 1.0 / matrix.Determinant();
