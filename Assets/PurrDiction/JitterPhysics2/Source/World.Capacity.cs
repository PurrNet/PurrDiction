    ...
    public partial class World
    {
        public struct Capacity : IEquatable<Capacity>
        {
            ...
            public int BodyCount
            {
                ...
                set
                {
                    if (value < DefaultBodyCount)
                        throw new ArgumentOutOfRangeException(nameof(value), "The value must be at least 32768.");
            ...
            public int ContactCount
            {
                ...
                set
                {
                    if (value < DefaultContactCount)
                        throw new ArgumentOutOfRangeException(nameof(value), "The value must be at least 65536.");
            ...
            public int ConstraintCount
            {
                ...
                set
                {
                    if (value < DefaultConstraintCount)
                        throw new ArgumentOutOfRangeException(nameof(value), "The value must be at least 32768.");
            ...
            public int SmallConstraintCount
            {
                ...
                set
                {
                    if (value > ConstraintCount)
                        throw new ArgumentOutOfRangeException(nameof(value), "The value must be smaller than or equal to the constraint count.");
