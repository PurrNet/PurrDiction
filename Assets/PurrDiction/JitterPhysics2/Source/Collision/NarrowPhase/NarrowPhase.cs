    ...
    public static class NarrowPhase
    {
        ...
        private struct MprEpaSolver
        {
                ...
                where TA : ISupportMappable where TB : ISupportMappable
            {
                ...
                normal = ctri.Normal * (1.0 / MathR.Sqrt(ctri.NormalSq));
                ...
                where TA : ISupportMappable where TB : ISupportMappable
            {
                ...
                */
                ...
                if (JVector.Dot(v2.V, normal) <= 0.0) return false;
                ...
                while (true)
                {
                    ...
                    if (JVector.Dot(v3.V, normal) <= 0.0)
                    {
                        return false;
                    }
                ...
                while (true)
                {
                    ...
                    if (delta * delta <= collideEpsilon * collideEpsilon * normalSq || penetration <= 0.0 ||
                        phase2 > maxIter)
                    {
                        if (hit)
                        {
                            Real invnormal = 1.0 / MathR.Sqrt(normalSq);
                ...
                where TA : ISupportMappable where TB : ISupportMappable
            {
                ...
                if (MathR.Abs(penetration) > NumericEpsilon) normal = ctri.ClosestToOrigin * (1.0 / penetration);
                else normal = ctri.Normal * (1.0 / MathR.Sqrt(ctri.NormalSq));
        ...
        /// </summary>
        private static readonly Real EpaPenetrationThreshold = 0.02;
        ...
        public static bool MprEpa<TA,TB>(in TA supportA, in TB supportB,
            ...
            where TA : ISupportMappable where TB : ISupportMappable
        {
            return MprEpa(supportA, supportB, orientationA, orientationB, positionA, positionB, out pointA, out pointB,
                out normal, out penetration, EpaPenetrationThreshold);
        }
        ...
        public static bool MprEpa<TA,TB>(in TA supportA, in TB supportB,
            ...
            where TA : ISupportMappable where TB : ISupportMappable
        {
            return MprEpa(supportA, supportB, orientationB, positionB, out pointA, out pointB, out normal,
                out penetration, EpaPenetrationThreshold);
        }
