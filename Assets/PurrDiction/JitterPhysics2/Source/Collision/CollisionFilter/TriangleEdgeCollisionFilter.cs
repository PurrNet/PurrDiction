...
namespace Jitter2.Collision
{
    ...
    public class TriangleEdgeCollisionFilter : INarrowPhaseFilter
    {
        ...
        /// </summary>
        public Real EdgeThreshold { get; set; } = 0.01;

        // approx 2.5°
        private Real cosAngle = 0.999;

        /// <summary>
        /// A tweakable parameter.
        /// </summary>
        public Real ProjectionThreshold { get; set; } = 0.5;
            ...
            ref JVector pointA, ref JVector pointB, ref JVector normal, ref Real penetration)
        {
            ...
            n = b - a;
            pma = collP - a;
            var d0 = (pma - JVector.Dot(pma, n) * n * (1.0 / n.LengthSquared())).LengthSquared();

            n = c - a;
            pma = collP - a;
            var d1 = (pma - JVector.Dot(pma, n) * n * (1.0 / n.LengthSquared())).LengthSquared();

            n = c - b;
            pma = collP - b;
            var d2 = (pma - JVector.Dot(pma, n) * n * (1.0 / n.LengthSquared())).LengthSquared();
            ...
            bool isSpeculative = penetration < 0.0;
            ...
            JVector midPoint = 0.5 * (pointA + pointB);
