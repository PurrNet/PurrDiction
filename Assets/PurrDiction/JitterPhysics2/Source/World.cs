    ...
    public sealed partial class World : IDisposable
    {
        ...
        public readonly struct SpanData
        {
            ...
            public long TotalBytesAllocated =>
                _world.memRigidBodies.TotalBytesAllocated +
                _world.memContacts.TotalBytesAllocated +
                _world.memConstraints.TotalBytesAllocated +
                _world.memSmallConstraints.TotalBytesAllocated;

            public Span<RigidBodyData> ActiveRigidBodies => _world.memRigidBodies.Active;
            public Span<RigidBodyData> InactiveRigidBodies => _world.memRigidBodies.Inactive;
            public Span<RigidBodyData> RigidBodies => _world.memRigidBodies.Elements;

            public Span<ContactData> ActiveContacts => _world.memContacts.Active;
            public Span<ContactData> InactiveContacts => _world.memContacts.Inactive;
            public Span<ContactData> Contacts => _world.memContacts.Elements;

            public Span<ConstraintData> ActiveConstraints => _world.memConstraints.Active;
            public Span<ConstraintData> InactiveConstraints => _world.memConstraints.Inactive;
            public Span<ConstraintData> Constraints => _world.memConstraints.Elements;

            public Span<SmallConstraintData> ActiveSmallConstraints => _world.memSmallConstraints.Active;
            public Span<SmallConstraintData> InactiveSmallConstraints => _world.memSmallConstraints.Inactive;
            public Span<SmallConstraintData> SmallConstraints => _world.memSmallConstraints.Elements;
        }
        ...
        private Real stepDt = 0.01;
        private Real substepDt = 0.01;
        private Real invStepDt = 100.0;
        ...
        public void Remove(RigidBody body)
        {
            ...
            Debug.Assert((body.InternalIsland != null && body.InternalIsland.InternalBodies.Count == 1));
        ...
        {
            body.InternalSleepTime = Real.MaxValue;
        }
