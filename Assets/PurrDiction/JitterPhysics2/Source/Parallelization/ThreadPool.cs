...
namespace Jitter2.Parallelization
{
    ...
    public sealed class ThreadPool
    {
        ...
        public static readonly Real ThreadsPerProcessor = 0.9;
        ...
        private ConcurrentQueue<ITask>[] queues = Array.Empty<ConcurrentQueue<ITask>>();
        ...
        public static int ThreadCountSuggestion => Math.Max((Environment.ProcessorCount * ThreadsPerProcessor).ToInt(), 1);
