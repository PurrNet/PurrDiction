...
namespace Jitter2
{
    public sealed partial class World
    {
        ...
        {
            public InvalidCollisionTypeException(Type proxyA, Type proxyB) : base($"Don't know how to handle collision between {proxyA} and {proxyB}." +
        ...
        /// </summary>
        public Real SpeculativeRelaxationFactor { get; set; } = 0.9;
        ...
        /// timestep of 0.01.
        /// </summary>
        public Real SpeculativeVelocityThreshold { get; set; } =10.0;
        ...
        private void Detect(IDynamicTreeProxy proxyA, IDynamicTreeProxy proxyB)
        {
            ...
            if (!colliding)
            {
                ...
                if (!success || toi > stepDt || toi == 0.0) return;
