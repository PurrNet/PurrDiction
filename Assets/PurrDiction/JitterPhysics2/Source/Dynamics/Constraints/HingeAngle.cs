...
namespace Jitter2.Dynamics.Constraints
{
    ...
    public unsafe class HingeAngle : Constraint
    {
        ...
        public void Initialize(JVector axis, AngularLimit limit)
        {
            ...
            data.Softness = 0.001;
            data.LimitSoftness = 0.001;
            data.BiasFactor = 0.2;
            data.LimitBias = 0.1;

            data.MinAngle = MathR.Sin((Real)limit.From / 2.0);
            data.MaxAngle = MathR.Sin((Real)limit.To / 2.0);
        ...
        public AngularLimit Limit
        {
            ...
            {
                ref HingeAngleData data = ref handle.Data;
                data.MinAngle = MathR.Sin((Real)value.From / 2.0);
                data.MaxAngle = MathR.Sin((Real)value.To / 2.0);
            }
        }
