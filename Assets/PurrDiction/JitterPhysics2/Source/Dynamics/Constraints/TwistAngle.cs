...
namespace Jitter2.Dynamics.Constraints
{
    ...
    public unsafe class TwistAngle : Constraint
    {
        ...
        public void Initialize(JVector axis1, JVector axis2, AngularLimit limit)
        {
            ...
            data.Angle1 = MathR.Sin((Real)limit.From / 2.0);
            data.Angle2 = MathR.Sin((Real)limit.To / 2.0);
        ...
        public AngularLimit Limit
        {
            ...
            {
                ref TwistLimitData data = ref handle.Data;
                data.Angle1 = MathR.Sin((Real)value.From / 2.0);
                data.Angle2 = MathR.Sin((Real)value.To / 2.0);
            }
        }
        ...
        public JAngle Angle
        {
            get
            {
                ...
                return (JAngle)(2.0 * MathR.Asin(error));
            }
        }
        ...
        public static void IterateTwistAngle(ref ConstraintData constraint, Real idt)
        {
            ...
            if (data.Clamp == 1)
            {
                data.AccumulatedImpulse = MathR.Min(data.AccumulatedImpulse, 0.0);
            }
            else
            {
                data.AccumulatedImpulse = MathR.Max(data.AccumulatedImpulse, 0.0);
            }
