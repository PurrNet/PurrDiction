    ...
    public sealed partial class World
    {
        ...
        public void Step(Real dt, bool multiThread = true)
        {
            ...
            for (int i = 0; i < substeps; i++)
            {
                ...
                RelaxVelocities(velocityRelaxations);  // FAST SWEEP
            }
        ...
        private void AssertNullBody()
        {
            ...
            Debug.Assert(rigidBody.InverseMass == 0);
            Debug.Assert(MathHelper.UnsafeIsZero(ref rigidBody.InverseInertiaWorld, 1e-6));
        }
        ...
        private void ForeachActiveBody(bool multiThread)
        {
            ...
            foreach (var body in bodies)
            {
                if (body.IsStatic)
                {
                    Debug.Assert(MathHelper.UnsafeIsZero(ref body.Data.InverseInertiaWorld, 1e-6));
                    Debug.Assert(body.Data.InverseMass == 0);
                }
            }
#endif
        ...
        private void RelaxVelocities(int iterations)
        {
